...
type ButtonActionPrintProps = React.ButtonHTMLAttributes<HTMLButtonElement> & {
  className?: string;
};

const ButtonActionPrint = ({ className, ...props }: ButtonActionPrintProps) => {
...
export default ButtonActionPrint;
