...
let GetAllProdutosService = class GetAllProdutosService {
    constructor(produtoService) {
        this.produtoService = produtoService;
    }
    execute(ativo) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.produtoService.getAll(ativo);
        });
    }
};
exports.GetAllProdutosService = GetAllProdutosService;
exports.GetAllProdutosService = GetAllProdutosService = __decorate([
    (0, typedi_1.Service)(),
