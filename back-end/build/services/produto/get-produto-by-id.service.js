...
let GetProdutoByIdService = class GetProdutoByIdService {
    ...
    execute(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.produtoService.getById(id);
        });
    }
};
exports.GetProdutoByIdService = GetProdutoByIdService;
exports.GetProdutoByIdService = GetProdutoByIdService = __decorate([
    (0, typedi_1.Service)(),
