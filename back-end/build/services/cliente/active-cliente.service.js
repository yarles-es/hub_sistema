...
exports.ActiveClienteService = void 0;
...
let ActiveClienteService = class ActiveClienteService {
    constructor(clienteService, mensalidadeService, createMensalidadeService) {
    ...
    execute(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const clienteExists = yield this.clienteService.getClienteById(id);
            if (!clienteExists) {
                throw new NotFoundError_1.NotFoundError('Cliente não encontrado');
            }
            if (clienteExists.ativo) {
                throw new BadRequestError_1.BadRequestError('Cliente já está ativado');
            }
            const [mensalidade] = yield this.mensalidadeService.findMensalidadesByClienteIdAndStatus(id, client_1.StatusMensalidade.PENDENTE);
            if (mensalidade) {
                yield this.mensalidadeService.updateMensalidade(mensalidade.id, {
                    status: client_1.StatusMensalidade.CANCELADO,
                });
            }
            const cliente = yield this.clienteService.updateCliente(id, { ativo: true });
...
exports.ActiveClienteService = ActiveClienteService;
exports.ActiveClienteService = ActiveClienteService = __decorate([
    (0, typedi_1.Service)(),
