...
exports.DeleteMensalidadeService = void 0;
const typedi_1 = require("typedi");
const NotFoundError_1 = require("../../errors/NotFoundError");
const _mensalidade_service_1 = require("./@mensalidade.service");
let DeleteMensalidadeService = class DeleteMensalidadeService {
    ...
    execute(id, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.mensalidadeService.deleteMensalidade(id, transaction);
        });
    }
};
exports.DeleteMensalidadeService = DeleteMensalidadeService;
exports.DeleteMensalidadeService = DeleteMensalidadeService = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [_mensalidade_service_1.MensalidadeService])
], DeleteMensalidadeService);
