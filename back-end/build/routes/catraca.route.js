...
exports.catracaRoute = void 0;
const express_1 = require("express");
const typedi_1 = require("typedi");
const catraca_controller_1 = require("../controllers/catraca.controller");
const auth_login_middleware_1 = require("../middlewares/auth-login-middleware");
const router = (0, express_1.Router)();
const catracaController = typedi_1.Container.get(catraca_controller_1.CatracaController);
