...
const headers_auth_1 = require("../auth/headers.auth");
    ...
    login(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                (0, headers_auth_1.setAuthHeaders)(res, token);
                yield this.log.execute(user.id, 'Usuário logado');
